...
if set=="0" then
	sret=luci.sys.call("curl -Lfso /tmp/adnew.conf https://fastly.jsdelivr.net/gh/small-5/ad-rules/easylistchina+easylist.txt || curl -Lfso /tmp/adnew.conf https://easylist-downloads.adblockplus.org/easylistchina+easylist.txt")
	if sret==0 then
